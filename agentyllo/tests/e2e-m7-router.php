...
delete_transient( 'agyl_cb_mock' );
delete_transient( 'agyl_cb_openai' );
...
update_option( 'agyl_ai_usage_month', array( 'month' => gmdate( 'Y-m' ), 'cost_usd' => 25.0, 'tokens_in' => 0, 'tokens_out' => 0, 'calls' => 1, 'errors' => 0 ) );
